...
import fi.opendemocracy.voting.domain.RepresentationDataOnDemand;
...
privileged aspect RepresentationIntegrationTest_Roo_IntegrationTest {
    ...
    public void RepresentationIntegrationTest.testCountRepresentations() {
        ...
        long count = fi.opendemocracy.voting.domain.Representation.countRepresentations();
    ...
    public void RepresentationIntegrationTest.testFindRepresentation() {
        fi.opendemocracy.voting.domain.Representation obj = dod.getRandomRepresentation();
        ...
        obj = fi.opendemocracy.voting.domain.Representation.findRepresentation(id);
    ...
    public void RepresentationIntegrationTest.testFindAllRepresentations() {
        ...
        java.util.List<fi.opendemocracy.voting.domain.Representation> result = fi.opendemocracy.voting.domain.Representation.findAllRepresentations();
    ...
    public void RepresentationIntegrationTest.testFindRepresentationEntries() {
        ...
        java.util.List<fi.opendemocracy.voting.domain.Representation> result = fi.opendemocracy.voting.domain.Representation.findRepresentationEntries(0, (int) count);
    ...
    public void RepresentationIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyRepresentation(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        fi.opendemocracy.voting.domain.Representation merged =  obj.merge();
        obj.flush();
    ...
    public void RepresentationIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Representation' failed to initialize correctly", dod.getRandomRepresentation());
        fi.opendemocracy.voting.domain.Representation obj = dod.getNewTransientRepresentation(Integer.MAX_VALUE);
    ...
    public void RepresentationIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Representation' with identifier '" + id + "'", fi.opendemocracy.voting.domain.Representation.findRepresentation(id));
    }

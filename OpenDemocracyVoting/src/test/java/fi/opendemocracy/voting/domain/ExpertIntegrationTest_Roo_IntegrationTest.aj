...
privileged aspect ExpertIntegrationTest_Roo_IntegrationTest {
    ...
    public void ExpertIntegrationTest.testCountExperts() {
        ...
        long count = fi.opendemocracy.voting.domain.Expert.countExperts();
    ...
    public void ExpertIntegrationTest.testFindExpert() {
        fi.opendemocracy.voting.domain.Expert obj = dod.getRandomExpert();
        ...
        obj = fi.opendemocracy.voting.domain.Expert.findExpert(id);
    ...
    public void ExpertIntegrationTest.testFindAllExperts() {
        ...
        java.util.List<fi.opendemocracy.voting.domain.Expert> result = fi.opendemocracy.voting.domain.Expert.findAllExperts();
    ...
    public void ExpertIntegrationTest.testFindExpertEntries() {
        ...
        java.util.List<fi.opendemocracy.voting.domain.Expert> result = fi.opendemocracy.voting.domain.Expert.findExpertEntries(0, (int) count);
    ...
    public void ExpertIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyExpert(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        fi.opendemocracy.voting.domain.Expert merged =  obj.merge();
        obj.flush();
    ...
    public void ExpertIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Expert' failed to initialize correctly", dod.getRandomExpert());
        fi.opendemocracy.voting.domain.Expert obj = dod.getNewTransientExpert(Integer.MAX_VALUE);
    ...
    public void ExpertIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Expert' with identifier '" + id + "'", fi.opendemocracy.voting.domain.Expert.findExpert(id));
    }

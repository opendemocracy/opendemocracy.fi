 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fi.opendemocracy.voting.domain.Category.class)
public class CategoryForm extends CustomComponent implements EntityEditor {
    ...
    public CategoryForm() {
    	setCaption(ThemeConstants.TAB_CAPTION_NEW_CATEGORY);
    	setIcon(ThemeConstants.TAB_ICON_NEW_CATEGORY);
        buildMainLayout();

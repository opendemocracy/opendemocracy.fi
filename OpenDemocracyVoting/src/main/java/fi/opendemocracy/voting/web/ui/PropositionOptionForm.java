 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fi.opendemocracy.voting.domain.PropositionOption.class)
public class PropositionOptionForm extends CustomComponent implements EntityEditor {

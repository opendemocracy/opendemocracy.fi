 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fi.opendemocracy.voting.domain.ODUser.class)
public class ODUserForm extends CustomComponent implements EntityEditor {
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // adminField
        adminField = new CheckBox();
        adminField.setWidth("-1px");
        adminField.setHeight("-1px");
        adminField.setCaption("Admin");
        adminField.setImmediate(true);
        fieldLayout.addComponent(adminField);

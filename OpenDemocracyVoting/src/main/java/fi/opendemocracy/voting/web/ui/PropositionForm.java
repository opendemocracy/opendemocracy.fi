 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fi.opendemocracy.voting.domain.Proposition.class)
public class PropositionForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TwinColSelect propositionOptionsField;
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // authorField
        authorField = new ComboBox();
        authorField.setWidth("-1px");
        authorField.setHeight("-1px");
        authorField.setCaption("Author");
        authorField.setImmediate(true);
        fieldLayout.addComponent(authorField);
        ...
        // propositionOptionsField
        propositionOptionsField = new TwinColSelect();
        propositionOptionsField.setWidth("-1px");
        propositionOptionsField.setHeight("-1px");
        propositionOptionsField.setCaption("Proposition Options");
        propositionOptionsField.setImmediate(true);
        fieldLayout.addComponent(propositionOptionsField);

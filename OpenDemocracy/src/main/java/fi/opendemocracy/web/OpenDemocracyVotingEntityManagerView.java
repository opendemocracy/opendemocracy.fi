...
public class OpenDemocracyVotingEntityManagerView extends CustomComponent
	...
	public static class HomeView extends VerticalLayout implements
		...
		Label loginMsg;
		String loginTxt = "<h1 class=\"v-label-h1\" style=\"text-align: center;\">Welcome to OpenDemocracy Alpha</h1>" +
				"Select an option above to begin<br \\><br \\>" +
				"The project is decribed briefly in the leaflet from ICT Showroom 2012, where OpenDemocracy was published.<br \\>" +
				"For more information you can read our wiki and join our mailing list<br \\><br \\>" +
				"<a href=\"http://opendemocracy.wikidot.com\"><span>OpenDemocracy wiki</span></a><br \\><br \\>" +
				"<a href=\"http://opendemocracy.fi/v1.pdf\"><span>OpenDemocracy leaflet</span></a><br \\><br \\>" +
				"<a href=\"http://www.freelists.org/list/opendemocracy\"><span>OpenDemocracy mailing list</span></a><br \\><br \\>" +
				"<a href=\"https://github.com/opendemocracy/opendemocracy.fi\"><span>OpenDemocracy GitHub repository</span></a><br \\><br \\>";

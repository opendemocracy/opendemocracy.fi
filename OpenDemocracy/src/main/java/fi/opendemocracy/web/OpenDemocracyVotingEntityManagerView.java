...
import fi.opendemocracy.web.ui.LoginView;
...
public class OpenDemocracyVotingEntityManagerView extends CustomComponent implements TabNavigator.ViewChangeListener {
    ...
    protected abstract class SidebarItem extends AbsoluteLayout {
         ...
         */
        public abstract boolean ownsView(TabNavigator.View current);
    }

    private class EntitySidebarItem extends SidebarItem {
        private Button selectButton = new NativeButton();
        private Button newButton = new NativeButton("New");
        private final Class<? extends TabNavigator.View> viewClass;

        public EntitySidebarItem(final String viewName, Class<? extends TabNavigator.View> viewClass) {
            super(viewName);
        ...
        public boolean ownsView(TabNavigator.View current) {
            return viewClass.isAssignableFrom(current.getClass());
        }
    }

    public static class WelcomeView extends VerticalLayout implements TabNavigator.View {
        public WelcomeView() {
        	setReadOnly(true);
        	setCaption("Home");
            setMargin(true);
    ...
    public void navigatorViewChange(TabNavigator.View previous, TabNavigator.View current) {
    ...
    private void addEntityViewsToList() {
        ...
        entityViews.put("login", LoginView.class);
        EntitySidebarItem loginMenuItem = new EntitySidebarItem("Login", LoginView.class);

        for (final String key : entityViews.keySet()) {
            Class viewClass = entityViews.get(key);

            if (TabNavigator.View.class.isAssignableFrom(viewClass)) {

...
public class AuthenticationWithOpenIdUserDetailsGetter implements UserDetailsService {
    ...
    public AuthenticationWithOpenIdUserDetailsGetter(NormalizedOpenIdAttributesBuilder normalizedOpenIdAttributesBuilder) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
		...
		List<ODUser> oduserList = ODUser.findODUsersByOpenIdIdentifier(username)
				.getResultList();

...
public class ODUserForm extends CustomComponent implements EntityEditor {
	...
	@AutoGenerated
	private ComboBox userRoleField;
	@AutoGenerated
	private TextField openIdIdentifierField;
	@AutoGenerated
	...
	private VerticalLayout buildFieldLayout() {
		...
		// userRoleField
		userRoleField = new ComboBox();
		userRoleField.setWidth("-1px");
		userRoleField.setHeight("-1px");
		userRoleField.setCaption("User Role");
		userRoleField.setImmediate(true);
		fieldLayout.addComponent(userRoleField);

		// openIdIdentifierField
		openIdIdentifierField = new TextField();
		openIdIdentifierField.setWidth("-1px");
		openIdIdentifierField.setHeight("-1px");
		openIdIdentifierField.setCaption("Open Id Identifier");
		openIdIdentifierField.setImmediate(true);
		fieldLayout.addComponent(openIdIdentifierField);

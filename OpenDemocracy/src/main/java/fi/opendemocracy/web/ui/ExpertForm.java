 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = fi.opendemocracy.domain.Expert.class)
public class ExpertForm extends CustomComponent implements EntityEditor {
	...
	private VerticalLayout buildFieldLayout() {
		...
		// expertiseField
		expertiseField = new TextField();
		expertiseField.setWidth("-1px");
		expertiseField.setHeight("-1px");
		expertiseField.setCaption("Expertise");
		expertiseField.setImmediate(true);
		fieldLayout.addComponent(expertiseField);

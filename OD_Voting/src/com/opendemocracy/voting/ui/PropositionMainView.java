...
public class PropositionMainView extends VerticalLayout implements TabSheet.SelectedTabChangeListener {
    ...
    public PropositionMainView(VotingApplication app) {
        ...
        l1.setMargin(false);
        l1.addComponent(app.getPropositionList());
        l1.setSizeFull();
        ...
        t = new TabSheet();
        t.setSizeFull();
        t.addTab(l1, "List propositions", new ThemeResource("icons/16/propositions.png"));
        t.addTab(l2, "Add proposition", new ThemeResource("icons/16/document-add.png"));
